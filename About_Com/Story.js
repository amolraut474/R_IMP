            ...
            <div className='Story-container'>
                <div className='Story-row'>
                    <div className='story-part-1'>
                        <div class="Custom_Card"><div><h2 class="card-icon-c"><i class="bi bi-telephone-outbound-fill"></i></h2></div><div class="card-title-box"><h2 class="card-title">Passage of Lorem Ipsum</h2><p class="card-desciption">2012-2017</p></div></div>
                    </div>
